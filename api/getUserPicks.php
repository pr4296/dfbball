...
$query = "select * from user_picks u where pickDate = DATE(DATE_SUB((select min(startTime) from game where playedStatus = 'UNPLAYED'), INTERVAL ".$interval." HOUR)) and username = '".$username."';";
