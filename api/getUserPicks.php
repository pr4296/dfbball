...
$query = "select * from user_picks u where pickDate = DATE(DATE_ADD((select max(startTime) from game where playedStatus <> 'UNPLAYED'), INTERVAL 18 HOUR)) and username = '".$username."';";
